...
CREATE TYPE status_time AS ENUM ('On time', 'Late', 'Early');
...
(
    id             serial primary key,
    process        varchar not null unique,
...
(
    id           serial primary key,
    measure_unit varchar not null unique,
    status       boolean not null default true
);
...
FROM areas a
         INNER JOIN users u ON u.id = a.assistant
         JOIN users u2 ON u2.id = a.director;


-- Insert

INSERT INTO areas (id, area) VALUES (1, 'SRIA. ACADEMICA');
INSERT INTO areas (id, area) VALUES (2, 'DATID');
INSERT INTO areas (id, area) VALUES (3, 'DAMI');
INSERT INTO areas (id, area) VALUES (4, 'DACEA');
INSERT INTO areas (id, area) VALUES (5, 'DATEFI');
INSERT INTO areas (id, area) VALUES (6, 'DAF');
INSERT INTO areas (id, area) VALUES (7, 'DPSE');
INSERT INTO areas (id, area) VALUES (8, 'ABOGADO GENERAL');


INSERT INTO public.users (id, name, lastname, email, password, phone_number, status, role)
VALUES (DEFAULT, 'Joel', 'Herrera', 'joel@utez.edu.mx', '123456', '7774138126', DEFAULT, 'Assistant'::roles),
       (DEFAULT, 'Mario', 'Perez', 'mario@utez.edu.mx', '123456', '6776862478', DEFAULT, 'Director'::roles),
       (DEFAULT, 'Carlos', 'Martinez', 'carlos@utez.edu.mx', '123456', '9079766678', DEFAULT, 'Assistant'::roles);
